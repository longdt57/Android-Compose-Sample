...
class MediaPermissionChecker(private val context: Context) : PermissionChecker {
    ...
    override fun isPermissionGranted(): Boolean =
        isMediaImagePermissionGranted() || isMediaImagePermissionGratedPartially()
    ...
    private fun isMediaImagePermissionGratedPartially(): Boolean {
